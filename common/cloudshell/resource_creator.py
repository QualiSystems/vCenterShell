...
class CloudshellResourceCreator(object):
    ...
    def create_resource_for_deployed_vm(self, template_vcenter_name, template_folder, vcenter_template, vm_name, vm_uuid):
        ...
        resource_path = template_vcenter_name + '/' + template_folder
