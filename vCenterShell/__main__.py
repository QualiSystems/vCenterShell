...
from vCenterShell.commands.CommandExecuterService import *
...
def main():
    ...
    if len(sys.argv) > 2 and sys.argv[1] == "debug":
        cloudshellConnectData = {"user": "admin",
                                 "password": "admin",
                                 "domain": "Global",
        ...
        os.environ["resourceContext".upper()] = '{"name":"VCenter Template Request", "address":"Service",' \
                                                ...
                                                '"vCenter Template":"vCenter/QualiSB/Alex/test",' \
                                                '"VM Power State":"True","VM Storage":"eric ds cluster", ' \
